...
export const login = async (req, res) => {
    ...
    if (!cookieConsent) {
        return res.status(400).json({ success: false, message: "Cookie consent is required to proceed." });
    }
    ...
    try {
        ...
        if (cookieConsent) {
            ...
            tokenResponse.message = "Token is available but not stored in cookies.";
        }
