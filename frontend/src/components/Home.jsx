      ...
      <main className="pt-28  lg:h-screen h-auto  flex justify-center items-center  z-0">
        <section className='w-[50%] h-full gap-14 flex flex-col p-14'>
          ...
          <section className='  flex justify-center items-center gap-5'>
            <Link to={'createResume'}><button className='cursor-pointer font-bold rounded-2xl bg-[#54df71] text-white p-3 text-center  h-14 hover:border hover:border-[#54df71] hover:text-[#54df71] hover:bg-transparent'>Create Your Resume</button></Link>
