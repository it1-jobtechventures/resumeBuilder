...
const Login = () => {
  ...
  return (
    <>
      <mian>
        <div className="h-screen flex items-center justify-center bg-cover bg-center text-black" style={{ backgroundImage: "url('/path-to-your-image.jpg')" }}>
          <div className="bg-white bg-opacity-10 backdrop-blur-md p-8 rounded-lg shadow-lg max-w-sm w-full text-center">
            <h2 className="text-black text-2xl font-semibold mb-4">
              {isSignUp ? "Sign Up" : "Login"}
            </h2>
            <input type="text" placeholder="Username" className="w-full p-2 mb-2 rounded bg-gray-100 text-gray-900 focus:outline-none"/>
            {isSignUp && (
              <input type="email" placeholder="Email" className="w-full p-2 mb-2 rounded bg-gray-100 text-gray-900 focus:outline-none"/>
            )}
            <input type="password" placeholder="Password" className="w-full p-2 mb-2 rounded bg-gray-100 text-gray-900 focus:outline-none"/>
