...
//       return <p className="text-center text-red-500">No template or data selected.</p>;
//     }
//   return (
//     <>
//         <main>
...
//                     <p>{formData.email}</p>
//                     <p>{formData.phone}</p>
//                     <img src={selectedTemplate.preview} alt="Selected Template" className="mt-4 w-full" />
//                 </div>
//             </div>
//         </main>
//     </>
